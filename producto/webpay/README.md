...
1.- En el caso de **MASTERCARD**, se bloqueará todo reintento de transacción rechazada a partir del reintento número 11° (undécimo) en adelante, dentro de 24 horas de realizada la transacción original. Los criterios que la marca utiliza para identificar un reintento es a través del código de comercio, el número de tarjeta y el monto de la transacción.
