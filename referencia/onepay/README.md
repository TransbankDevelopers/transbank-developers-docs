...
Dentro del flujo de venta, puedes utilizar un simulador de transacciones donde podras generar casos de éxito y fracaso, para utilizarlo sigue los siguientes pasos:
...
widthHeight <br> <i>  Number  </i> | Valor en pixeles para el tamaño que tendrá la imagen del código QR como ancho y alto. No soportado por los SDKs.
commerceLogoUrl <br> <i>  String  </i> | Indica la dirección al logo del comercio. Se utiliza en la aplicación OnePay para descargar y mostrar dicha imagen durante el proceso de compra. No soportado por los SDKs.
