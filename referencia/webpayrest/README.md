...
amount  <br> <i> xs: integer</i> | Formato número entero para transacciones en peso y decimal para transacciones en dólares. Largo máximo: 10
...
details[].status  <br> <i> xs:string </i> | Estado de la transacción
...
commerceId  <br> <i> xs:long </i> | (Opcional) Tienda mall que realizó la transacción. Largo: 12.
...
amount  <br> <i> xs:decimal </i> | (Opcional) Monto que se desea anular de la transacción. Largo máximo: 10.
commerceId  <br> <i> xs:long </i> | (Opcional) Tienda mall que realizó la transacción. Largo: 12.
...
status  <br> <i> xs:string </i> | Estado de la transacción
(AUTHORIZED, FAILED).
...
------   | -----------
type  <br> <i> xs:string </i> | Tipo de reembolso (REVERSE. NULLIFY).
authorization_code  <br> <i> xs:boolean </i> | Código de autorización
authorization_date  <br> <i> ISO8601 </i> | Fecha de la autorización de la transacción.
nullified_amount  <br> <i> xs:long </i> | Monto anulado.
balance  <br> <i> xs:long </i> | Monto restante.
